  ...
  return (
    <div className="threads-filters-row" aria-label="Loading thread filters" aria-busy="true">
      <div className="threads-filters">
        {[46, 72, 104].map((width) => (
          <span key={width} className="sk filter-tab-skeleton" style={{ width, height: 26, borderRadius: 5 }} />
        ))}
      </div>
      ...
      <main className="home-wrap">
        <header className="home-head">
          <div className="home-title">
            <img src={logoUrl} alt="" aria-hidden="true" className="home-logo" />
            <div>
              <h1 className="h-display">Roundtable.</h1>
              <div className="eyebrow tight">In consilio salus</div>
            </div>
          </div>
          {threadsLoaded ? (
              ...
              {visibleThreads.map((thread) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <Link className="title" to={`/threads/${thread.id}`} onClick={(e) => e.stopPropagation()}>
                        {thread.title}
                      </Link>
                      <div className="row-meta">
                        ...
                        {thread.pending_count > 0 ? (
                          <>
                            ...
                            <span style={{ color: "var(--accent)" }}>{thread.pending_count} pending</span>
                          </>
                        ) : null}
                        <span className="sep">·</span>
                    ...
                    <div className="right">
                      <StatusPill status={thread.display_status} pendingCount={thread.pending_count} />
        ...
        <footer className="home-foot">
          ...
          <span>
            <kbd className="kbd">N</kbd> new thread
          </span>
        </footer>
      </main>
    </>
